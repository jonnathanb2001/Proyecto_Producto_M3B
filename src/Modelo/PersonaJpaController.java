...
public class PersonaJpaController implements Serializable {
    ...
    public void create(Persona persona) {
        if (persona.getUsuarioList() == null) {
            persona.setUsuarioList(new ArrayList<>());
        }
        ...
        try {
            ...
            for (Usuario usuarioListUsuarioToAttach : persona.getUsuarioList()) {
                usuarioListUsuarioToAttach = em.getReference(usuarioListUsuarioToAttach.getClass(), usuarioListUsuarioToAttach.getIdusario());
    ...
    public void edit(Persona persona) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            for (Usuario usuarioListNewUsuarioToAttach : usuarioListNew) {
                usuarioListNewUsuarioToAttach = em.getReference(usuarioListNewUsuarioToAttach.getClass(), usuarioListNewUsuarioToAttach.getIdusario());
